 ...
 * @author GaryFaldi
 */
public class AdminDashboardMotor extends javax.swing.JFrame {

    
    private MotorController controller;
    private DefaultTableModel tableModel;
    /**
     * Creates new form AdminDashboardMotor
     */
    public AdminDashboardMotor() {
        initComponents();
    ...
    private void initTable() {
        ...
        tblMotor.setModel(tableModel);
    }
    
    private void loadData() {
        // Ambil data dari controller
        List<Motor> daftarMotor = controller.getAllMotor();
        ...
        for (Motor m : daftarMotor) {
            String statusStr = konversiStatusKeString(m.getStatus());
     ...
     private int konversiStringKeStatus(String statusText) {
        return statusText.equals("Tersedia") ? 1 : 0;
    }

    private String konversiStatusKeString(int statusValue) {
    ...
    private void tblMotorMouseClicked(java.awt.event.MouseEvent evt) {
        int barisTerpilih = tblMotor.getSelectedRow();
        if (barisTerpilih >= 0) {
            platTextField.setText(tblMotor.getValueAt(barisTerpilih, 0).toString());
            tipeTextField.setText(tblMotor.getValueAt(barisTerpilih, 1).toString());
            merkTextField.setText(tblMotor.getValueAt(barisTerpilih, 2).toString());
            hargaTextField.setText(tblMotor.getValueAt(barisTerpilih, 3).toString());
            
            String status = tblMotor.getValueAt(barisTerpilih, 4).toString();
    ...
    private void tampilkanHasilPencarian(List<Motor> hasilPencarian) {
        DefaultTableModel model = (DefaultTableModel) tblMotor.getModel();
        model.setRowCount(0); // Bersihkan tabel
        
        if (hasilPencarian.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Tidak ditemukan data motor yang sesuai");
            return;
        }
        
        for (Motor m : hasilPencarian) {
            String statusStr = konversiStatusKeString(m.getStatus());
    ...
    private void hapusButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hapusButtonActionPerformed
        ...
        if (plat.isEmpty()) {
            JOptionPane.showMessageDialog(this, "Pilih motor yang akan dihapus terlebih dahulu");
            return;
        }
        
        int konfirmasi = JOptionPane.showConfirmDialog(this, 
            "Yakin ingin menghapus motor dengan plat " + plat + "?", 
            "Konfirmasi Hapus", 
            JOptionPane.YES_NO_OPTION);
        
        if (konfirmasi == JOptionPane.YES_OPTION) {
            controller.hapusMotor(plat);
            loadData();
            clearForm();
    ...
    private void cariButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cariButtonActionPerformed
        ...
        List<Motor> hasilPencarian = controller.cariMotor(keyword);
    ...
    private void simpanButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_simpanButtonMouseClicked
        ...
        int statusInt = konversiStringKeStatus(status);

        controller.tambahMotor(plat, tipe, merk, harga, statusInt);
    ...
    private void updateButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateButtonActionPerformed
        ...
        controller.updateMotor(plat, tipe, merk, harga, String.valueOf(statusInt));
        
        loadData();
        clearForm();
        JOptionPane.showMessageDialog(this, "Data motor berhasil diupdate");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminDashboardMotor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminDashboardMotor().setVisible(true);
            }
        });
    }
